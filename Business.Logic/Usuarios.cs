...
namespace Business.Logic
{
    public class Usuarios
    {
        ...
        public Usuarios()
        {
             ...
             * 
             * Si se realiza esta practica sobre el MS SQL SERVER 2005 Express Edition entonces debe utilizar el siguiente connection string
             * 
            ...
            this.daUsuarios.UpdateCommand = new SqlCommand(" UPDATE usuarios  " +
                                                          ...
                                                          " telefono=@telefono, email=@email, celular=@celular, usuario=@suario, " +
            ...
            this.daUsuarios.DeleteCommand = new SqlCommand("DELETE FROM  from usuarios where id=@id", this.Conn);
        ...
        // estas propiedades son necesarias porque no implementamos la capa de acceso a datos por separado
